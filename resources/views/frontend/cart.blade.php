                       ...
                       this.state.items.map(function (item) {
                          return (
                            <tr key={item.id}>
                              ...
                              <td><a href="#" onClick={this.handleClick.bind(this,item)} ><i className="fa fa-pencil-square-o"></i></a></td>
                              <td><a href="#" onClick={this.handleDelete.bind(this,item)}><i className="fa fa-times"></i></a></td>
                            </tr>
                          );
                       },this) 
                  }
